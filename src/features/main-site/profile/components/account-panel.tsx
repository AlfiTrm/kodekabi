  ...
  return (
    <section className="rounded-2xl border border-white/8 bg-surface p-5">
      ...
      <dl className="mt-4 space-y-4 text-[9px]">
        <div className="flex justify-between gap-4 border-b border-white/6 pb-3"><dt className="text-foreground/40">Email</dt><dd className="text-right">nadia@mail.com <span className="text-green">✓</span></dd></div>
