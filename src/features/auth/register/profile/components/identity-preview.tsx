...
import type { Detective } from "../../detective/types/detective";
import type { BannerCosmetic, TitleCosmetic } from "../types/cosmetic";
...
export function IdentityPreview({ nickname, detective, title, banner, stats }: IdentityPreviewProps) {
  return (
    <section className="relative mx-auto w-full max-w-[380px] pt-7" aria-label="Pratinjau identitas pemain">
      <p className="absolute inset-x-0 top-0 text-center text-[10px] uppercase tracking-[0.12em] text-foreground/45">Identitas auditormu</p>
      ...
      <p className="mt-6 text-center text-[10px] text-foreground/45">Title dan banner bisa diganti secara independen.</p>
    </section>
  );
}
