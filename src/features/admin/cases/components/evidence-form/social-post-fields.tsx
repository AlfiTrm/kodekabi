...
export function SocialPostFields({ disabled, verified, onVerifiedChange, initial }: { disabled: boolean; verified: boolean; onVerifiedChange: (value: boolean) => void; initial?: AdminCaseEvidenceDetail }) {
  return (
    <div className="grid gap-5 md:grid-cols-2">
      ...
      <EvidenceDateTimeField label="Timestamp" name="timestamp" defaultValue={evidenceDateTimeValue(initial?.timestamp)} min="2020-01-01T00:00:00" max="2100-12-31T23:59:59" step={1} required disabled={disabled} />
